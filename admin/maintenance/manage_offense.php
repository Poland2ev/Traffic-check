...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Cập nhật ": "Thêm mới " ?> lỗi vi phạm</h3>
	</div>
	<div class="card-body">
		<form action="" id="offense-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group col-6">
				<label for="code" class="control-label">Mã lỗi vi phạm</label>
                <input name="code" id="code" maxlength="20" type="text" class="form-control form" value="<?php echo isset($code) ? $code : ''; ?>"/>
			</div>
			<div class="form-group col-6">
				<label for="name" class="control-label">Tên lỗi vi phạm</label>
			...
			<div class="form-group col-4">
				<label for="fine" class="control-label">Mức phạt</label>
            ...
            <div class="form-group col-4">
                ...
                <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Đang áp dụng</option>
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Ngừng áp dụng</option>
                </select>
			</div>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=maintenance/offenses">Hủy</a>
	</div>
</div>
<script>
